...
EXTERN streebog_xor_512_ssse3:PROC
EXTERN streebog_s_transform_ssse3:PROC
EXTERN streebog_p_transform_ssse3:PROC
EXTERN streebog_l_transform_ssse3:PROC

streebog_key_schedule_ssse3 PROC
    ...
    call streebog_xor_512_ssse3 ; tmp = K XOR C_i

    ; S-transformation
    mov rcx, r13 ; input
    mov rdx, r14 ; output
    call streebog_s_transform_ssse3
    ...
    mov rcx, r13
    mov rdx, r14
    call streebog_p_transform_ssse3
    ...
    mov rcx, r13
    mov rdx, r14
    call streebog_l_transform_ssse3
...
streebog_key_schedule_ssse3 ENDP
